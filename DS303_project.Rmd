...
<<<<<<< HEAD
write.csv(gender_sub, "gender_clean.csv", row.names = FALSE)
write.csv(test_titanic, "test_clean.csv", row.names = FALSE)
write.csv(train_titanic, "train_clean.csv", row.names = FALSE)
...
>>>>>>> c1870b760f5f38927038f6e54541f69f8dba6001
